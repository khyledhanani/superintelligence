...
COMMON="--maze_height 21 --maze_width 21 --n_walls 150 --score_function sfl --num_sfl_rollouts 10 --project JAXUED_VAE_COMPARISON --run_name plr_sfl_21x21 --gcs_bucket ucl-ued-project-bucket --gcs_prefix accel/plr_sfl_21x21 --buffer_dump_interval 10000 --num_updates 30000"
