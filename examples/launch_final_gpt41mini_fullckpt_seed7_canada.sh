#!/bin/bash
# ============================================================================
# FINAL GPT-4.1-mini (ACCEL + LLM) re-run — SEED 7 (canada, 3090 Ti)
...
#   bash examples/launch_final_gpt41mini_fullckpt_seed7_canada.sh
# ============================================================================
...
echo "=== [$(date)] LLM+ACCEL (GPT-4.1-mini, full ckpt) seed $SEED on canada starting ==="
