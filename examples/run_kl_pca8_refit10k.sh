...
for SEED in 1 2 3; do
    echo "=========================================="
    echo "Starting: pca_dims=8, refit every 10k updates, seed=${SEED}"
    echo "=========================================="
    ...
    PYTHONUNBUFFERED=1 python3 examples/maze_plr.py \
        ...
        --cmaes_pca_dims 20 --cmaes_pca_fitness_aware \
        ...
        --seed ${SEED} --run_name "cmaes_clutr_beta10_sfl_kl_pca20_refit10k_s${SEED}"
