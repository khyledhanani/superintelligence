#!/bin/bash
# ============================================================================
# FINAL GPT-4.1-mini (ACCEL + LLM) re-run — SEED 5 (albacore, 4070 Ti)
...
#   bash examples/launch_final_gpt41mini_fullckpt_seed5_albacore.sh
# ============================================================================
...
echo "=== [$(date)] LLM+ACCEL (GPT-4.1-mini, full ckpt) seed $SEED on albacore starting ==="
