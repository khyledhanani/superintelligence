...
prefabs = {
    ...
    "SmallCorridor": SmallCorridor.strip(),
    "SimpleCrossing": SimpleCrossing.strip(),
    "LargeCorridor": LargeCorridor.strip(),
    "FourRooms": FourRooms.strip(),
    "PerfectMaze": PerfectMaze.strip(),
}