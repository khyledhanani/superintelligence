...
prefabs = {
    ...
    "NarrowBridge": NarrowBridge.strip(),
    "ForkDeception": ForkDeception.strip(),
    "PerimeterRun": PerimeterRun.strip(),
    "SpiralPocket": SpiralPocket.strip(),
    "SymmetricCross": SymmetricCross.strip(),
    "ZigZagTunnel": ZigZagTunnel.strip(),
    "RoomKeyhole": RoomKeyhole.strip(),
    "DualLoopChoice": DualLoopChoice.strip(),
    "CentralChoke": CentralChoke.strip(),
    "LongDetour": LongDetour.strip(),
    "DeadendFan": DeadendFan.strip(),
    "OpenFieldBarriers": OpenFieldBarriers.strip(),
    "ParallelCorridors": ParallelCorridors.strip(),
    "CornerTrapEscape": CornerTrapEscape.strip(),
    "SnakeSpine": SnakeSpine.strip(),
}
