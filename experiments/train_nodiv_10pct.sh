...
BUF="/cs/student/project_msc/2025/csml/rhautier/injection_data/results/llm_inject_nodiv_seed0/merged_buffer_10pct.npz"

for s in 0 1 2; do
  echo "=== nodiv 10pct seed${s} ==="
  python examples/maze_plr.py \
    --project $PROJECT --wandb_entity $ENTITY \
    --wandb_group nodiv_10pct \
    --run_name ws_10pct_nodiv_seed${s} \
