#!/bin/bash
# Plain PLR on 21x21 (DR generation + PLR replay, no ACCEL, no CMA-ES)
# with --exploratory_grad_updates so agent trains on DR levels too.
# 3 seeds sequential.
