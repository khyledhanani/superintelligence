#!/bin/bash
# Evaluate final checkpoints (step 119 = 30k updates) on 21x21 test levels
# 100 rollouts per level, logs to wandb.
#
# Usage:
#   bash experiments/gpu_scripts/run_eval_21x21.sh              # all methods
#   bash experiments/gpu_scripts/run_eval_21x21.sh accel        # single method
...
LOCAL_BASE=/tmp/eval_checkpoints_21x21
RESULTS_DIR=/cs/student/project_msc/2025/csml/rhautier/eval_results_21x21
CKPT_STEP=${2:-119}
...
METHODS[plr]="plr_uniformdr_sfl_21x21_v1:plr_uniformdr_sfl_21x21_v1/0,plr_uniformdr_sfl_21x21_v1/1,plr_uniformdr_sfl_21x21_v1/2"

# ACCEL with uniform DR (seeds 0,1,2)
METHODS[accel]="accel_uniformdr_sfl_21x21_v1:accel_uniformdr_sfl_21x21_v1/0,accel_uniformdr_sfl_21x21_v1/1,accel_uniformdr_sfl_21x21_v1/2"

# CMA-ES + PLR (seeds 0,1,2)
METHODS[cmaes_nomut]="cmaes_plr_nomut_sfl_21x21_v3:cmaes_plr_nomut_sfl_21x21_v3/0,cmaes_plr_nomut_sfl_21x21_v3/1,cmaes_plr_nomut_sfl_21x21_v3/2"

# CMA-ES + ACCEL (seeds 0,1,2)
METHODS[cmaes_accel]="cmaes_accel_sfl_21x21_v2:cmaes_accel_sfl_21x21_v2/0,cmaes_accel_sfl_21x21_v2/1,cmaes_accel_sfl_21x21_v2/2"

# CMA-ES + Latent Interp (seeds 3,4,5)
METHODS[cmaes_latent_interp]="cmaes_latent_mut_sfl_21x21_v2:cmaes_latent_mut_sfl_21x21_v2/3,cmaes_latent_mut_sfl_21x21_v2/4,cmaes_latent_mut_sfl_21x21_v2/5"

# CMA-ES + Latent Noise (seeds 0,1,2)
METHODS[cmaes_latentnoise]="cmaes_plr_latentnoise_21x21_v1:cmaes_plr_latentnoise_21x21_v1/0,cmaes_plr_latentnoise_21x21_v1/1,cmaes_plr_latentnoise_21x21_v1/2"

# CMA-ES only (seeds 0,1,2)
METHODS[cmaes_only]="cmaes_only_sfl_21x21_v3:cmaes_only_sfl_21x21_v3/0,cmaes_only_sfl_21x21_v3/1,cmaes_only_sfl_21x21_v3/2"
...
for METHOD in "${!METHODS[@]}"; do
    ...
    $PY $EVAL_SCRIPT --batch \
        ...
        --wandb_project vae_21x21_results \
