#!/bin/bash
# ACCEL with uniform wall count DR (0-150 walls) on 21x21.
...
RUN=accel_uniformdr_sfl_21x21_v1
...
for SEED in "${SEEDS[@]}"; do
    echo ""
    echo "=== ACCEL + uniform DR 21x21 seed $SEED ==="
    $PY $SCRIPT \
...
echo ""
echo "ACCEL + uniform DR 21x21 done."
